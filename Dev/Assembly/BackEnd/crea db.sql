...
CREATE TABLE associaTag (progetto int, tag varchar(60), posizione int, PRIMARY KEY (progetto, posizione));
ALTER TABLE associaTag ADD CONSTRAINT FKassociaTag524966 FOREIGN KEY (Progetto) REFERENCES progetto (ID) ON DELETE CASCADE;
ALTER TABLE associaTag ADD CONSTRAINT FKassociaTag918278 FOREIGN KEY (tag) REFERENCES tag (nome);
ALTER TABLE candidato ADD CONSTRAINT FKcandidato524966 FOREIGN KEY (Progetto) REFERENCES progetto (ID) ON DELETE CASCADE;
ALTER TABLE candidato ADD CONSTRAINT FKcandidato918278 FOREIGN KEY (utente) REFERENCES utente (mail) ON DELETE CASCADE;
ALTER TABLE progetto ADD CONSTRAINT FKProgetto579424 FOREIGN KEY (Leader) REFERENCES Utente (mail) ON DELETE CASCADE;
